...
const useContractData = (): UseContractData => {
            ...
            .then((events) => {
                setContractData((prev) => ({
                    ...
                    winners_list: events.map((ev) => ({
                        ...
                        prize_won: ev.returnValues.prize_won,
                    })),
                }));
            });
    };
                ...
                if (ev) {
                    if (ev.returnValues.is_complete === true) {
                        ...
                        setContractData((prev) => ({
                            ...prev,
                            participants_awaiting:
                                ev.returnValues.participants_list,
                        }));
                    }
                }
            });
        ...
        contract.methods
            ...
            .then((x: number) => {
                setContractData((prev) => ({
                    ...
                    player_stats: {
                        times_participated:
                            prev.player_stats?.times_participated ?? 0,
    ...
    const recalculate_player_stats = (address: string) => {
